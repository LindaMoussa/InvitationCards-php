                        ...
                        <div class="row">
                            <div class="menueList col-4">
                                <ul class="menueOptions list-unstyled pt-3">
                                    <li id="cardSizeBtn" class="text-center py-2"><i class="fa fa-columns fa-lg"></i>
                                        <p class="mb-0 pt-1"> Card Sizes </p>
                                    </li>
                                    <li id="bgColorBtn" class="text-center py-2"><i class="fas fa-palette fa-lg"></i>
                                        <p class="mb-0 pt-1"> Bg Colors </p>
                                    </li>
                                    <li class="text-center py-2"><i class="fas fa-image fa-lg"></i>
                                        <p class="mb-0 pt-1"> Bg Options </p>
                                    </li>
                                    <li id="clipBtn" class="text-center py-2"><i class="fa fa-cubes fa-lg"></i>
                                        <p class="mb-0 pt-1"> Clip Arts </p>
                                    </li>
                                    <li class="text-center py-2"><i class="fa fa-font  fa-lg"></i>
                                        <p class="mb-0 pt-1"> Text </p>
                                    </li>
                                    <li class="text-center py-2"><i class="fa fa-upload fa-lg"></i>
                                        <p class="mb-0 pt-1"> Upload </p>
                                    </li>
                            ...
                            <div class="col-7 optionList">
                                ...
                                <div class="textCustArea">
                                    ...
                                    <div id="firstPage">
                                        <h5 class="text-white py-3 text-center">Custom Text</h5>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    ...
                                    <canvas id="c" width="528" height="384" class="workSheet mb-4"></canvas>
                                </div>
